    ...
    return (
        <div id="contact" class="h-screen relative"><br />
            ...
            <div class="px-8 lg:mx-40 my-2">
                ...
                >
                  <AiFillGithub class="text-4xl mr-2 text-blue-500"/>
                </a>
                                <a
                  href="https://twitter.com/shariquealam52"
                >
                  <AiOutlineTwitter class="text-4xl mr-2 text-blue-500"/>
                </a>
                <a
                  href="https://www.linkedin.com/in/sharique-alam-4b0aa0195/"
                >
                  <FaLinkedinIn class="text-4xl mr-2 text-blue-500"/>
                </a>
                <a
                  href="https://www.instagram.com/i_m.sharique/"
                >
                  <AiFillInstagram class="text-4xl mr-2 text-blue-500"/>
                </a>
                </div>

            </div>

            <div class="text-center text-sm w-full absolute bottom-2">
